...
<p class="uk-text-lead uk-paragraph">{`A collection of utility classes to add spacing between elements.`}</p>
...
<Example component="margin" index={0} />
...
<Example component="margin" index={1} />
...
<Example component="margin" index={2} />
...
<Example component="margin" index={3} />
...
<Example component="margin" index={4} />
...
| `.uk-margin-remove-left@xl`<br /> `.uk-margin-remove-right@xl` | Affects device widths of _1080px_ and larger. |
...
| `.uk-margin-auto-left@xl`<br /> `.uk-margin-auto@xl`<br /> `.uk-margin-auto-right@xl` | Affects device widths of _1080px_ and larger. |
