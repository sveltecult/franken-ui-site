...
order: 6
name: JavaScript
title: UIkit JavaScript Integration
meta:
    description: Franken UI is compatible with UIkit 3. Learn how to integrate its JavaScript in your project.
javascript: none
---

# JavaScript

Once you have [installed Franken UI](installation.md), include the JavaScript files on your page by adding them to the `<head>` section. You can also choose to use the `defer` attribute to delay script execution.
