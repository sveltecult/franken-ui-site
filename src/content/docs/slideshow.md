...
<p class="mt-2 text-xl text-muted-foreground">Create a responsive slideshow with images and videos.</p>
...
<div class="uk-position-relative uk-visible-toggle" tabindex="-1" uk-slideshow>
    ...
    <a class="text-white uk-position-center-left uk-position-small uk-hidden-hover" href uk-slidenav-previous uk-slideshow-item="previous"></a>
    <a class="text-white uk-position-center-right uk-position-small uk-hidden-hover" href uk-slidenav-next uk-slideshow-item="next"></a>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-3">
    <div>
        ...
        <div class="mb-6 text-lg font-semibold tracking-tight">Slide</div>
    ...
    <div>
        ...
        <div class="mb-6 text-lg font-semibold tracking-tight">Fade</div>
    ...
    <div>
        ...
        <div class="mb-6 text-lg font-semibold tracking-tight">Scale</div>
    ...
    <div>
        ...
        <div class="mb-6 text-lg font-semibold tracking-tight">Pull</div>
    ...
    <div>
        ...
        <div class="mb-6 text-lg font-semibold tracking-tight">Push</div>
...
```example
<div class="uk-position-relative uk-visible-toggle" tabindex="-1" uk-slideshow="ratio: 7:3; animation: push">
...
```example
<div class="uk-position-relative uk-visible-toggle" tabindex="-1" uk-slideshow="min-height: 300; max-height: 600; animation: push">
...
<div uk-slideshow="animation: push">
    ...
    <ul class="uk-slideshow-nav uk-dotnav justify-center mt-5"></ul>
...
<div class="uk-position-relative uk-visible-toggle" tabindex="-1" uk-slideshow="animation: push">
    ...
    <ul class="uk-slideshow-items">
        ...
        <li>
            <iframe src="https://www.youtube-nocookie.com/embed/aqz-KE-bpKQ?autoplay=1&amp;controls=0&amp;showinfo=0&amp;rel=0&amp;loop=1&amp;modestbranding=1&amp;wmode=transparent&amp;playsinline=1" width="1920" height="1080" allowfullscreen uk-cover></iframe>
        </li>
    </ul>
...
<div class="uk-position-relative uk-visible-toggle" tabindex="-1" uk-slideshow="animation: push">
    ...
    <ul class="uk-slideshow-items">
        <li>
            <img src="/images/photo.jpg" alt="" uk-cover>
            <div class="uk-position-center uk-position-small uk-text-center text-white text-white">
                <h2 class="uk-margin-remove text-lg">Center</h2>
                <p class="uk-margin-remove">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
        </li>
        <li>
            <img src="/images/dark.jpg" alt="" uk-cover>
            <div class="uk-position-bottom uk-position-medium uk-text-center text-white">
        ...
        <li>
            <img src="/images/light.jpg" alt="" uk-cover>
            <div class="uk-overlay uk-overlay-primary uk-position-bottom uk-text-center backdrop-blur-sm text-white">
        ...
        <li>
            <img src="/images/dark.jpg" alt="" uk-cover>
            <div class="uk-overlay uk-overlay-default uk-position-bottom-right uk-position-small backdrop-blur-sm">
...
<div class="uk-position-relative uk-visible-toggle" tabindex="-1" uk-slideshow="animation: push">
    ...
    <ul class="uk-slideshow-items">
        <li>
            <img src="/images/photo.jpg" alt="" uk-cover>
            <div class="uk-position-center uk-position-small uk-text-center text-white">
                <h2 class="text-lg mb-2" uk-slideshow-parallax="x: 100,-100">Heading</h2>
...
<div class="uk-position-relative uk-visible-toggle" tabindex="-1" uk-slideshow="animation: push">
    ...
    <ul class="uk-slideshow-items">
        <li>
            ...
            <div class="uk-position-cover" uk-slideshow-parallax="opacity: 0,0,0.2; backgroundColor: #000,#000"></div>
            <div class="uk-position-center uk-position-medium uk-text-center text-white">
                <div uk-slideshow-parallax="scale: 1,1,0.8">
                    <h2 class="text-lg mb-2" uk-slideshow-parallax="x: 200,0,0">Heading</h2>
...
<div class="uk-position-relative uk-visible-toggle" tabindex="-1" uk-slideshow="animation: fade">
    ...
    <ul class="uk-slideshow-items">
        <li>
            <img src="/images/photo.jpg" alt="" uk-cover>
            <div class="text-white backdrop-blur-sm uk-overlay uk-overlay-primary uk-position-bottom uk-text-center uk-transition-slide-bottom">
                <h3 class="uk-margin-remove">Bottom</h3>
                <p class="uk-margin-remove">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
        </li>
        ...
        <li>
            <img src="/images/light.jpg" alt="" uk-cover>
            <div class="text-white backdrop-blur-sm uk-overlay uk-overlay-primary uk-position-right uk-text-center uk-transition-slide-right uk-width-medium">
