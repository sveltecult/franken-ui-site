...
group: components
name: Dropnav
title: Tailwind CSS Dropnav Component
meta:
    description: Create dropdown menus for any navigation.
javascript: full
---

# Tailwind CSS Dropnav
...
<span class="uk-badge uk-badge-danger">v0.0.10+</span> If you are using the `presetQuick()`, you can skip this step. On your `tailwind.config.js` file, add the Dropnav component within the `ui()` plugin.
...
<nav uk-dropnav>
    <ul class="uk-tab">
        ...
        <li>
            <a class="px-4 pb-3 pt-2" href>Parent <span class="ml-2" uk-drop-parent-icon></span></a>
            <div class="uk-dropdown">
                <ul class="uk-nav uk-dropdown-nav">
                    <li class="uk-active"><a href="#">Active</a></li>
                    <li><a href="#">Item</a></li>
