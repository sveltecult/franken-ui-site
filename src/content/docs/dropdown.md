...
group: components
name: Dropdown
title: Tailwind CSS Dropdown Component
meta:
...
<div class="uk-inline mr-2">
    ...
    <div class="p-6" uk-dropdown>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
</div>

<div class="uk-inline">
    <button class="uk-button uk-button-default" type="button">Click</button>
    <div class="p-6" uk-dropdown="mode: click">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
</div>
```
...
You can place a grid from Tailwind CSS inside a drop.

```html
<div class="w-96" uk-drop>
    <div class="grid grid-cols-2">...</div>
</div>
```

You can use the Tailwind CSS utility classes and it will follow its width.

```example
<button class="uk-button uk-button-default" type="button">Hover</button>
<div class="w-96" uk-dropdown>
...
```example
<div class="boundary uk-panel uk-placeholder h-96">
...
```example
<div class="target uk-panel uk-placeholder h-96">
