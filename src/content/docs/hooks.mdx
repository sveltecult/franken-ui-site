...
<p class="uk-text-lead uk-paragraph">{`Allows easy customization by hooking into predefined selectors, reducing selector repetition and enabling effortless global changes.`}</p>
...
Using the `presetQuick()`
will get you up and running quickly. You can pass your own customization like so:
...
<span class="uk-label uk-label-primary">Note</span> You can also use `hook-misc`
to override other selectors.
      ...
      a: (
        <Fragment>
          <p>
            ...
            classes in each component's documentation page.
          </p>
        </Fragment>
      ),
    },
    {
      q: "What's the difference between preset and presetQuick()?",
      a: (
        <Fragment>
          <p>
            The <code class="uk-codespan">preset</code> is an object that offers
            full control over component selection, allowing you to cherry-pick
            what you need.
          </p>
          <p class="uk-margin-small-top">
            On the other hand, <code class="uk-codespan">presetQuick()</code> is
            a function that returns an object accepting theme and overrides
            options. It includes all UIkit components and provides a{" "}
      ...
      a: (
        <Fragment>
          <p>
            ...
            rules. If you follow the{" "}
            <a class="uk-link" href="/docs/optimization">
              optimization
            </a>{" "}
            guide, your final CSS will be much leaner.
          </p>
        </Fragment>
      ),
    },
