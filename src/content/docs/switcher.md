...
group: components
name: Switcher
title: Tailwind CSS Switcher Component
meta:
...
<span class="uk-badge uk-badge-danger">v0.0.10+</span> If you are using the `presetQuick()`, you can skip this step. On your `tailwind.config.js` file, add the Switcher component within the `ui()` plugin.
...
```example
<ul class="uk-subnav uk-subnav-primary" uk-switcher="connect: .switcher-container">
    <li><a href="#">Active</a></li>
    <li><a href="#">Item</a></li>
    <li><a href="#">Item</a></li>
</ul>

<h4 class="mt-5">Container 1</h4>

<ul class="uk-switcher switcher-container mt-5">
    <li>Hello!</li>
    <li>Hello again!</li>
    <li>Bazinga!</li>
</ul>

<h4 class="mt-5">Container 2</h4>
...
```example
<ul class="uk-subnav uk-subnav-primary" uk-switcher="animation: uk-animation-fade">
    <li><a href="#">Item</a></li>
    <li><a href="#">Item</a></li>
    <li><a href="#">Item</a></li>
</ul>
...
```example
<ul class="uk-subnav uk-subnav-primary" uk-switcher="animation: uk-animation-slide-left-medium, uk-animation-slide-right-medium">
    <li><a href="#">Item</a></li>
    <li><a href="#">Item</a></li>
    <li><a href="#">Item</a></li>
</ul>
...
<ul class="uk-subnav uk-subnav-primary" uk-switcher>...</ul>
