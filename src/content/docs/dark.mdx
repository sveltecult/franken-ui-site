...
order: 3
name: Dark Mode
title: Dark Mode with Dark Mode Switcher
meta:
  description: Learn how to configure and build a dark mode switcher using Franken UI.
javascript: none
---

# Dark Mode with Dark Mode Switcher

<p class="uk-text-lead uk-paragraph">{`Learn how to configure and build a dark mode switcher using Franken UI.`}</p>

Offering a dark version for your website is more of an expected feature rather than a nice to have nowadays. Luckily, Tailwind CSS has a dark mode functionality enabled and the components from Franken UI also support it by using the "class" option. If you are using the <code class="uk-codespan">presetQuick()</code>, everything is already setup for you.
