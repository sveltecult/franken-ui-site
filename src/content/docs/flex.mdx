...
| `.uk-flex-left@xl`<br/>`.uk-flex-center@xl`<br/>`.uk-flex-right@xl`<br/>`.uk-flex-between@xl`<br/>`.uk-flex-around@xl` | Only affects device widths of _1080px_ and higher.                                                 |
...
| `.uk-flex-stretch@xl`<br/> `.uk-flex-top@xl`<br/> `.uk-flex-middle@xl`<br/> `.uk-flex-bottom@xl` | Only affects device widths of _1080px_ and higher.                      |
...
| `.uk-flex-row@xl`<br/> `.uk-flex-column@xl` | Only affects device widths of _1080px_ and higher.        |
...
| `.uk-flex-first@xl`<br/>`.uk-flex-last@xl` | Only affects device widths of _1080px_ and higher. |
...
| `.uk-flex-initial@xl`<br/> `.uk-flex-none@xl`<br/> `.uk-flex-1@xl` | Only affects device widths of _1080px_ and higher.        |
